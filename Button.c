//MCONFAT+CGDCONT=1,"IP","VODAFONE"~AT#FTPOPEN="78.189.180.167","coskunkazma","kartal25",0~AT#FTPPUT="test"~AT#FTPAPP="test"~AT#SD=1,0,9999,"78.189.180.167",0,0,1~41ATC1234~
...
char atc18[] = "AT#SH=1";// soketi kapatýr
char atc19[] = "AT#SCFG=1,1,300,90,600,50";// soket ayarý
char atc20[] = "AT#SO=1";
char atc21[] = "AT&K0";
...
//UART
 ...
 while(PORTB.F7 == 0)
 {
  while(EEPROM_Read(tr) != '\0')
  {
   ...
   else if(EEPROM_Read(tr) != '~' && f6 == 1)  //plaka
   {
